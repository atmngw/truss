...
import (
	...
	"github.com/atmngw/truss/gengokit"
	templateFileAssets "github.com/atmngw/truss/gengokit/template"
	"github.com/atmngw/truss/svcdef"

	"github.com/atmngw/truss/gengokit/gentesthelper"
)
...
func TestApplyTemplateFromPath(t *testing.T) {
	const def = `
		...
		import "github.com/atmngw/truss/deftree/googlethirdparty/annotations.proto";
	...
	conf := gengokit.Config{
		GoPackage: "github.com/atmngw/truss",
		PBPackage: "github.com/atmngw/truss/gengokit/general-service",
	}
...
func TestAllTemplates(t *testing.T) {
	const goPackage = "github.com/atmngw/truss/gengokit"
	const goPBPackage = "github.com/atmngw/truss/gengokit/general-service"
	...
	conf := gengokit.Config{
		GoPackage: "github.com/atmngw/truss/gengokit",
		PBPackage: "github.com/atmngw/truss/gengokit/general-service",
	}
