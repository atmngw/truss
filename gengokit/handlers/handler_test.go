...
import (
	...
	helper "github.com/atmngw/truss/gengokit/gentesthelper"
...
func TestApplyServerTempl(t *testing.T) {
	...
	conf := gengokit.Config{
		GoPackage: "github.com/atmngw/truss/gengokit/general-service",
	...
	expected := `
		...
		import (
			...
			pb "github.com/atmngw/truss/gengokit/general-service"
		)
