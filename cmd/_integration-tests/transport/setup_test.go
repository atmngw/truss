...
import (
	...
	handler "github.com/atmngw/truss/cmd/_integration-tests/transport/transportpermutations-service/handlers"
	svc "github.com/atmngw/truss/cmd/_integration-tests/transport/transportpermutations-service/svc"
)
