# Truss ![Build Status](https://github.com/atmngw/truss/workflows/Go/badge.svg?branch=master)
...
1. Install Truss with
	...
	```
	go get -u -d github.com/atmngw/truss
	cd $GOPATH/src/github.com/atmngw/truss
	make dependencies
	make
	```
